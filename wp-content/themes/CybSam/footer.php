            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="" class="foo-logo d-block mb-4"><img src="<?php echo get_template_directory_uri()?>/img/core-img/logo2.png" alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="<?php echo get_template_directory_uri()?>img/bg-img/2.jpg" alt="">
                            </div>
                            <div class="post-content">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        &copy; <script>document.write(new Date().getFullYear());</script>  <a href="">HowTinue Inc</a> | All Rights Reserved - Designed by <a href="#" target="_blank">CybSam</a>
</p>
                    </div>
                    <div class="col-12 col-sm-6">
