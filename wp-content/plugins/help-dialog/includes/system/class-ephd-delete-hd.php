...
class EPHD_Delete_HD {
	...
	private function reset_all_handler( $action ) {
		...
		$designs_config = [ EPHD_Config_Specs::DEFAULT_ID => EPHD_Config_Specs::get_default_hd_config( EPHD_Config_DB::EPHD_DESIGNS_CONFIG_NAME ) ];
		ephd_get_instance()->designs_config_obj->update_config( $designs_config );

		$contact_forms_config = [ EPHD_Config_Specs::DEFAULT_ID => EPHD_Config_Specs::get_default_hd_config( EPHD_Config_DB::EPHD_CONTACT_FORMS_CONFIG_NAME ) ];
		ephd_get_instance()->contact_forms_config_obj->update_config( $contact_forms_config );
