	...
	public static function autoload( $class ) {
		...
		if ( $classes === null ) {
			$classes = array(
				...
				// CHANNELS
				'ephd_channels_page'                 =>  'includes/admin/channels/class-ephd-channels-page.php',
				'ephd_channels_display'              =>  'includes/admin/channels/class-ephd-channels-display.php',
				'ephd_channels_ctrl'                 =>  'includes/admin/channels/class-ephd-channels-ctrl.php',
				'ephd_channels_db'                   =>  'includes/admin/channels/class-ephd-channels-db.php',
				...
				// FAQs and ARTICLES
				'ephd_faqs_articles_page'   =>  'includes/admin/faqs-articles/class-ephd-faqs-articles-page.php',
				'ephd_faqs_articles_display'=>  'includes/admin/faqs-articles/class-ephd-faqs-articles-display.php',
				'ephd_faqs_articles_ctrl'   =>  'includes/admin/faqs-articles/class-ephd-faqs-articles-ctrl.php',
				'ephd_faqs_articles_db'     =>  'includes/admin/faqs-articles/class-ephd-faqs-articles-db.php',
