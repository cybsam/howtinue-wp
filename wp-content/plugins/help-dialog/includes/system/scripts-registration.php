 ...
 * Queue for FRONT-END pages using our plugin features
 */
/* function ephd_enqueue_font() {
	wp_enqueue_style( 'ephd-icon-fonts' );
}
add_action( 'ephd_enqueue_font_scripts', 'ephd_enqueue_font' ); */
...
// Help Dialog Channels page
function ephd_load_admin_help_dialog_channels_script() {
	$suffix = ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '' : '.min';
	...
	// Widgets admin page
	wp_enqueue_script( 'ephd-admin-help-dialog-channels-scripts', Echo_Help_Dialog::$plugin_url . 'js/admin-help-dialog-channels' . $suffix . '.js', array('jquery'), Echo_Help_Dialog::$version );
	wp_localize_script( 'ephd-admin-help-dialog-channels-scripts', 'ephd_help_dialog_vars', ephd_get_common_admin_script_vars() );
}
...
function ephd_load_admin_help_dialog_faqs_articles_script() {
	...
	wp_enqueue_script( 'ephd-admin-help-dialog-faqs-articles-scripts', Echo_Help_Dialog::$plugin_url . 'js/admin-help-dialog-faqs-articles' . $suffix . '.js', array('jquery', 'jquery-ui-core','jquery-ui-dialog','jquery-effects-core','jquery-effects-bounce', 'jquery-ui-sortable'), Echo_Help_Dialog::$version );
	wp_localize_script( 'ephd-admin-help-dialog-faqs-articles-scripts', 'ephd_help_dialog_vars', ephd_get_common_admin_script_vars() );
}
