...
/**
 * Display Help Dialog FAQs/Articles page
 *
 * @copyright   Copyright (C) 2018, Echo Plugins
 * @license http://opensource.org/licenses/gpl-2.0.php GNU Public License
 */
class EPHD_FAQs_Articles_Page {
	...
	/**
	 * Displays the Help Dialog FAQs/Articles page with top panel
	 */
	...
	/**
	 * Return configuration array for FAQs view in FAQs/Articles admin page
	 *
	 * @return array
	 */
	...
	/**
	 * Get configuration array for FAQs/Articles views of Help Dialog admin page
	 *
	 * @return array
	 */
	...
	public function get_faqs_questions( $widget ) {
		...
		foreach ( $widget['faqs_sequence'] as $article_id ) {
			foreach ( $this->all_faqs as $article ) {
				if ( $article_id == $article->faq_id ) {
					$questions[] = $article;
					break;
				}
			}
