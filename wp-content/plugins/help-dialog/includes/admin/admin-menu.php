...
function ephd_add_plugin_menus() {
	...
	add_menu_page( __( 'Help Dialog', 'help-dialog' ), __( 'Help Dialog', 'help-dialog' ),
						'manage_options', 'ephd-help-dialog', array( new EPHD_Need_Help_Page(), 'display_need_help_page'), '', 7 );

	add_submenu_page( 'ephd-help-dialog', __( 'Help Dialog Widgets', 'help-dialog' ), __( 'Widgets', 'help-dialog' ),
						'manage_options', 'ephd-help-dialog-widgets', array( new EPHD_Widgets_Display(), 'display_page'), 10 );

/* 	add_submenu_page( 'ephd-help-dialog', __( 'Help Dialog Channels', 'help-dialog' ), __( 'Chat', 'help-dialog' ),
		'manage_options', 'ephd-help-dialog-channels', array( new EPHD_Channels_Display(), 'display_page'), 10 ); */

	add_submenu_page( 'ephd-help-dialog', __( 'Help Dialog FAQs', 'help-dialog' ), __( 'FAQs', 'help-dialog' ),
						'manage_options', 'ephd-help-dialog-faqs-articles', array( new EPHD_FAQs_Articles_Display(), 'display_page'), 15 );
