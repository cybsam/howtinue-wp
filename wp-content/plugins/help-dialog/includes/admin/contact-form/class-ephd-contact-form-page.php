...
class EPHD_Contact_Form_Page {
	...
	private $contact_form_specs;
	private $contact_forms_config;
	private $messages = array(); // error/warning/success messages

	public function __construct( $widgets_config, $contact_forms_config ) {
		$this->widgets_config = $widgets_config;
		$this->contact_form_specs = EPHD_Config_Specs::get_fields_specification( EPHD_Config_DB::EPHD_CONTACT_FORMS_CONFIG_NAME );
	...
	public function display_page() {
		...
		if ( ! current_user_can( EPHD_Utilities::EPHD_ADMIN_CAPABILITY ) ) {
	...
	private function get_test_contact_form_submission_box_html( $contact_submission_email ) {
        ...
        <div class="ephd-cf__test-email-form">
            ...
            <div class="ephd-cf__test-email-form__actions">
                ...
                <input type="hidden" name="contact_form_id" value="<?php echo esc_attr( $this->contact_forms_config[EPHD_Config_Specs::DEFAULT_ID]['contact_form_id'] ); ?>">
	...
	public function get_design_form_box_html( $contact_form ) {
		...
		<div class="ephd-cf__design-form__content">
			<ul class="ephd-cf__design-fields">   <?php
                ...
                EPHD_HTML_Elements::text( ['specs' => 'contact_title', 'value' => $contact_form['contact_title'] ] );
