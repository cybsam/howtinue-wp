		...
		return [
			...
			'reach'      => [
				...
				[
					...
					'title'         => __( 'Help Dialog Total C.T.R.', 'help-dialog' ),
					'tooltip_title' => __( 'Number of Clicks to Open the Help Dialog.', 'help-dialog' ),
					'tooltip_desc'  => sprintf( esc_html__( '%sC.T.R.%s measures usage of the Help Dialog in relation to page views. %sView:%s When a page is loaded for longer than 5 seconds, a view is recorded. %sClick:%s When the Help Dialog Launcher Icon is clicked, a click is recorded.', 'help-dialog' ),
										'<strong>', '</strong>', '<br><br><strong>', '</strong>', '<br><br><strong>', '</strong>' ) . '<hr/>' .
					                    esc_html__( 'Formula', 'help-dialog' ) . ': ' . esc_html__( 'Click-through Rate = Views / launcher clicks', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_1" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a>.',
				...
				[
					...
					'title'         => __( 'Most Engaged Help Dialogs by C.T.R.', 'help-dialog' ),
					'tooltip_title' => __( 'On Which Pages Did Users Most Often Open the Help Dialog?', 'help-dialog' ),
					//'tooltip_desc'  => __( 'These pages are either too complex to understand, or they are of great interest to the user who is looking for more information.', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_2" target="_blank">' . __( 'Learn More', 'help-dialog' ) . '</a>.',
					'tooltip_desc'  => esc_html__( 'These pages are either too complex to understand, or they are of great interest to the user who is looking for more information.', 'help-dialog' ) .
										' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_2" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a><hr/>' .
					                   sprintf( esc_html__( '%sC.T.R.%s measures usage of the Help Dialog in relation to page views. %sView:%s When a page is loaded for longer than 5 seconds, a view is recorded. %sClick:%s When the Help Dialog Launcher Icon is clicked, a click is recorded.', 'help-dialog' ),
						                   '<strong>', '</strong>', '<br><br><strong>', '</strong>', '<br><br><strong>', '</strong>' ) . '<hr/>' .
					                   esc_html__( 'Formula', 'help-dialog' ) . ': ' . esc_html__( 'Click-through Rate = Views / launcher clicks', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_1" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a>.',
				...
				[
					'type'          => 'table',
					'css_class'     => 'ephd-ap-results--ctr',
					'title'         => __( 'Least Engaged Help Dialogs by C.T.R.', 'help-dialog' ),
					'tooltip_title' => __( 'On Which Pages Did Users Least Often Open the Help Dialog?', 'help-dialog' ),
					'tooltip_desc'  => esc_html__( 'These pages are either too simple or not interesting enough for user to ask about.', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_3" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a><hr/>' .
				                       sprintf( esc_html__( '%sC.T.R.%s measures usage of the Help Dialog in relation to page views. %sView:%s When a page is loaded for longer than 5 seconds, a view is recorded. %sClick:%s When the Help Dialog Launcher Icon is clicked, a click is recorded.', 'help-dialog' ),
				                       '<strong>', '</strong>', '<br><br><strong>', '</strong>', '<br><br><strong>', '</strong>' ) . '<hr/>' .
				                       esc_html__( 'Formula', 'help-dialog' ) . ': ' . esc_html__( 'Click-through Rate = Views / launcher clicks', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_1" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a>.',
			...
			'content'    => [
				...
				[
					...
					'tooltip_desc'  => esc_html__( 'These pages have good FAQs that help users to better understand the topic or support their interest.', 'help-dialog' ) . '<hr/>' .
										sprintf( esc_html__( '%sC.T.R.%s measures usage of the FAQs in relation to Help Dialog views. %sView:%s When Help Dialog is opened, a view is recorded. %sClick:%s When FAQ is clicked, a click is recorded.', 'help-dialog' ),
										'<strong>', '</strong>', '<br><br><strong>', '</strong>', '<br><br><strong>', '</strong>' ) . '<hr/>' .
										esc_html__( 'Formula', 'help-dialog' ) . ': ' . esc_html__( 'Click-through Rate = Views / FAQ clicks', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_1" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a>.',
			...
			'per_page'    => [
				...
				[
					'type'          => 'multiple-col-2',
					'css_class'     => 'ephd-ap-results--multiple-col-2',
					'title'         => __( 'Help Dialog C.T.R.', 'help-dialog' ),
					'tooltip_title' => __( 'Number of Clicks to Open the Help Dialog.', 'help-dialog' ),
					'tooltip_desc'  => sprintf( esc_html__( '%sC.T.R.%s measures usage of the Help Dialog in relation to page views. %sView:%s When a page is loaded for longer than 5 seconds, a view is recorded. %sClick:%s When the Help Dialog Launcher Icon is clicked, a click is recorded.', 'help-dialog' ),
										'<strong>', '</strong>', '<br><br><strong>', '</strong>', '<br><br><strong>', '</strong>' ) . '<hr/>' .
										esc_html__( 'Formula', 'help-dialog' ) . ': ' . esc_html__( 'Click-through Rate = Views / launcher clicks', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_1" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a>.',
                ...
                */
				...
				[
					...
					'title'         => __( 'Contact Form C.T.R.', 'help-dialog' ),
					...
					'tooltip_desc'  => esc_html__( 'Rate of submissions versus views by a user on the Contact form.', 'help-dialog' ) . '<hr/>' .
										sprintf( esc_html__( '%sC.T.R.%s measures usage of the Contact form in relation to Contact Tab views. %sView:%s When Contact tab is opened, a view is recorded. %sSubmissions:%s When Contact form is submitted, a submissions is recorded.', 'help-dialog' ),
										'<strong>', '</strong>', '<br><br><strong>', '</strong>', '<br><br><strong>', '</strong>' ) . '<hr/>' .
										esc_html__( 'Formula', 'help-dialog' ) . ': ' . esc_html__( 'Click-through Rate = Views / Submissions', 'help-dialog' ) . ' <a href="https://www.helpdialog.com/elementor-docs/reach-analytics/#articleTOC_1" target="_blank">' . esc_html__( 'Learn More', 'help-dialog' ) . '</a>.',
