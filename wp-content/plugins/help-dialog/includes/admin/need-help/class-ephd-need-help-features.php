...
class EPHD_Need_Help_Features {
	...
	private static function get_feature_box( $feature ) {
		...
		<div class="ephd-nh__feature-container__col ephd-nh__feature__content-col">
			<h3 class="ephd-nh__feature-name<?php echo $feature['plugin'] != 'core' && $feature['plugin'] != 'crel' ? ' ephd-nh__feature-name--pro' : ''; ?>"><?php echo esc_html( $feature['name'] ); ?></h3>   <?php
	...
	private static function get_features_config() {
		...
		return [
			[
				...
				'docs'      => 'https://www.helpdialog.com/elementor-docs/searching-content/',
			],
			[
				'category'  => 'help-dialog',
				...
				'config'    => admin_url( 'admin.php?page=ephd-help-dialog-contact-form' ),
				'docs'      => 'https://www.helpdialog.com/elementor-docs/contact-form-overview/',
			],
			[
				'category'  => 'help-dialog',
				...
				'docs'      => 'https://www.helpdialog.com/elementor-docs/engagement-analytics/',
			],
			[
				'category'  => 'help-dialog',
			...
			[
				...
				'view'      => admin_url( 'admin.php?page=ephd-plugin-analytics' ),
				'docs'      => 'https://www.helpdialog.com/elementor-docs/analytics-overview/',
			],
			[
				'category'  => 'design',
