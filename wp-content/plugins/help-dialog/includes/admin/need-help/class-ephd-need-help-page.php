		...
		<div class="ephd-nh__getting-started-container">
            ...
            <div class="ephd-nh__gs__header-container">
                ...
                <div class="ephd-nh__header__text">
                    <h2 class="ephd-nh__header__title"><?php esc_html_e( 'Welcome to Help Dialog!', 'help-dialog' ); ?></h2>
                    <p class="ephd-nh__header__desc"><?php esc_html_e( 'Choose pages to show Help Dialog widgets and define the FAQs for each page.', 'help-dialog' ); ?></p><?php

                    // Show link to Help Dialog page
                    if ( ! empty( $this->widget_url ) ) {   ?>
                        <a href="<?php echo esc_url( $this->widget_url ); ?>" class="ephd-kb__cta-link" target="_blank"><?php esc_html_e( 'View My Help Dialog', 'help-dialog' ); ?></a>  <?php
                    }   ?>
                </div>

                <div class="ephd-nh__header__img">
                    <img src="<?php echo esc_url( Echo_Help_Dialog::$plugin_url . 'img/need-help/need-help-featured-image.jpg' ); ?>">
                </div>
            ...
            <div class="ephd-nh__gs__body-container">
	            ...
	            EPHD_HTML_Forms::display_step_cta_box( array(
		            ...
		            'html'                  => EPHD_Core_Utilities::get_admin_page_link( 'page=ephd-help-dialog-faqs-articles#faqs', __( 'Create FAQs', 'help-dialog' ), false ) ) );    ?>
