...
class EPHD_HTML_Admin {
	...
	private static function admin_page_view_fill_missing_with_default( $page_view ){
		...
		$default_page_view = array(
			...
			// Shared
			'active'                    => false,
			'minimum_required_capability' => EPHD_Utilities::EPHD_ADMIN_CAPABILITY,
			'list_id'                   => '',
			'list_key'                  => '',
			...
			'top_actions_minimum_required_capability' => EPHD_Utilities::EPHD_ADMIN_CAPABILITY,
			'list_bottom_actions_html'  => '',
			'bottom_actions_minimum_required_capability' => EPHD_Utilities::EPHD_ADMIN_CAPABILITY,
			'boxes_list'                => array(),
	...
	public static function get_welcome_message( $icon_img_url, $title, $message ) {
		...
		<div class="ephd__welcome-message">
			<div class="ephd__welcome-message__header">
				<img class="ephd__welcome-message__icon" src="<?php echo esc_url( Echo_Help_Dialog::$plugin_url . $icon_img_url ); ?>">
			</div>
	...
	public static function display_config_error_page( $wp_error = '' ) {
		...
		$title = $wp_error ? __( 'Cannot load configuration.', 'help-dialog' ) . ' (' . $wp_error . ')' : __( 'Cannot load configuration.', 'help-dialog' ); ?>
		<div id="ephd-admin-page-wrap" class="ephd-admin-page-wrap--config-error">  <?php
			EPHD_HTML_Forms::notification_box_middle( [ 'type' => 'error', 'title' => $title, 'desc' =>  EPHD_Utilities::contact_us_for_support() ] ); ?>
		</div>  <?php
	}
		...
		<div class="ephd-admin__form__header">
			<div class="ephd-admin__form-title">
				<span class="ephd-admin__form-title-icon">
					<img src="<?php echo esc_url( Echo_Help_Dialog::$plugin_url . 'img/edit-hd-icon.png' ); ?>">
				</span>
